...
public:
	...
	constexpr Color(unsigned char r, unsigned char g, unsigned char b, unsigned char a = 255u)
		...
		a(a)
	{}
	constexpr Color(unsigned int r, unsigned int g, unsigned int b, unsigned int a = 255u)
		:
	...
	{}
	constexpr Color(unsigned int DWORD_BGRA)
		:
	...
	{
		return Color(255u - r, 255u - g, 255u - b);
	}
	Color& Invert()
	{
