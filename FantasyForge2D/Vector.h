...
using uchar1	= type1<unsigned char>;
using int1		= type1<int>;
using uint1		= type1<unsigned int>;
...
using uchar2	= type2<unsigned char>;
...
using uchar3	= type3<unsigned char>;
...
using uchar4	= type4<unsigned char>;
