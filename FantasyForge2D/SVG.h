...
public:
	...
	static SVG GeneratePolygon(unsigned int nSides, vec2 pos = { 0.0f,0.0f }, float rot = 0.0f, vec2 scale = { 1.0f,1.0f });
	static SVG GenerateStar(unsigned int nPoints, float inner_radius_ratio, vec2 pos = { 0.0f,0.0f }, float rot = 0.0f, vec2 scale = { 1.0f,1.0f });
};
